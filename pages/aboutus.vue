...
const description =
  "บริษัทจัดจำหน่ายริบบิ้นคุณภาพดี โดยเรามีทั้งในรูปแบบหน้าร้านและออนไลน์พร้อมบริการจัดส่งทั่วประเทศไทย";
...
useSeoMeta({
  ...
  ogImage: image,
  twitterImage: image,
  keywords: "RS RIBBON, เกี่ยวกับเรา",
});
</script>
<template>
  <div>
    ...
    <div class="w-full px-6 mb-10 lg:mb-0">
      <div class="pl-4 mb-6 border-l-4 border-blue-500">
        ...
        <h2 class="mt-2 text-3xl font-black md:text-5xl">RS RIBBON</h2>
      </div>
      <p class="mb-6 text-base leading-7">
        RS RIBBON เป็นบริษัทจัดจำหน่ายริบบิ้นคุณภาพดีชั้นนำในประเทศ ราคาย่อมเยา
        เปี่ยมคุณภาพ
      </p>
      <div class="m-auto">
